...
import AST.AST_EXP_SINGLE;
import AST.AST_VAR_LIST;
import AST.AST_VAR_LIST;
import AST.AST_DEC;
import AST.AST_FUNC_LIST;
import AST.AST_DEC_SINGLE;
...
public class FunctionHelpers { /*Helpers We Will Use*/
    public static PrintWriter file_writer = null;
    public static ArrayList<String> vars_ubi;
    public static ArrayList<ASSIGNED_VAR> assigned_temp;
    public static DATA_FLOW_GRAPH graph;
    public static DATA_FLOW_GRAPH.DATA_FLOW_NODE currNode;
    public static TEMP dummy = new TEMP(100);

    public static void setFileWriter(PrintWriter writer) {
        FunctionHelpers.file_writer = writer;
    }
    
    public static void setArrays(ArrayList<String> ubis){
        FunctionHelpers.vars_ubi = ubis;
    }
    ...
    public static boolean tempCheck(TYPE a, TYPE b){
        return true;
    }
